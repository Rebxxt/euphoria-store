...
@Component({
  selector: 'app-current-header-old',
  templateUrl: './current-header-old.component.html',
  styleUrls: ['./current-header-old.component.scss']
})
export class CurrentHeaderOldComponent implements OnInit {
